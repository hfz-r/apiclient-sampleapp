...
namespace SMS.Api.SampleApp.Managers
{
    public class AuthorizationManager
    {
        ...
        {
            // this is the URL where SMS should return the authorization code
            var returnUrl = new Uri(redirectUrl);

            // get the Authorization URL and redirect the user
            var authUrl = _apiAuthorizer.GetAuthorizationUrl(redirectUrl.ToString(), requestedPermissions, state);
